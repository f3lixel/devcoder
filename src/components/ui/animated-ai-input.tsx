...
type AIPromptMessage = { text: string; files?: Array<{ path: string; content: string }> };
type AIPromptProps = {
    onSubmit?: (message: AIPromptMessage) => void;
    disabled?: boolean;
};

export function AI_Prompt({ onSubmit, disabled }: AIPromptProps) {
    ...
    const onSend = useCallback(() => {
        ...
        setValue("");
        adjustHeight(true);
    }, [value, onSubmit, adjustHeight, disabled]);
