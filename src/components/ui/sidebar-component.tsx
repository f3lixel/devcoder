  ...
  return (
    <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          <path
            d="M409.5 215.5C258.3 188.3 202.5 59 194 0C188.167 24.3333 169.7 88.1 138.5 130.5C229.7 183.3 245.5 274.167 242 313C256.5 291.833 310.3 242.7 409.5 215.5Z"
            fill="url(#paint0_linear_2_13)"
          />
          <path
            d="M0.809093 279.746C152.23 305.69 209.101 434.522 218.09 493.45C223.721 469.069 241.658 405.151 272.505 362.494C180.87 310.452 164.317 219.72 167.494 180.859C153.17 202.145 99.78 251.723 0.809093 279.746Z"
          ...
          <defs>
            ...
            >
              ...
              <stop offset="1" stopColor="#6C8F65" />
            </linearGradient>
            <linearGradient
