...
export const Component = () => {
  ...
  return (
    <div className="flex w-56 flex-col items-start gap-y-1 rounded-xl border border-white/10 bg-black/50 p-1 text-white backdrop-blur-md overflow-hidden text-[14px]">
      <button
        className="flex w-full items-center justify-between rounded-lg px-2 py-1.5 text-[14px] hover:bg-white/10"
        onClick={() => router.push('/')}
      >
        Go To Dashboard
      </button>
      ...
      <button className="relative flex w-full items-center justify-end overflow-hidden rounded-lg px-2 py-1.5 text-[14px] hover:bg-white/10"
        onClick={() => {
      ...
      <div className="group relative flex h-7 w-full cursor-pointer items-center overflow-hidden rounded-lg text-[14px]">
        <AnimatePresence>
          {editing ? (
            <motion.div
              initial={{ y: -10, opacity: 0 }}
        ...
        <div className={clsx('pointer-events-none absolute left-0 h-full w-full bg-white/10 transition-colors', editing ? 'block' : 'hidden group-hover:block')} />
      </div>
      <button className="flex w-full items-center justify-between rounded-lg px-2 py-1.5 text-[14px] hover:bg-white/10">
        Project Settings
      ...
      <hr className="w-full border-white/10" />
      <button
        className="group relative flex h-7 w-full select-none items-center justify-end overflow-hidden rounded-lg px-2 text-[14px] text-red-400 hover:bg-red-500/10"
